...
<div class="wrapper">
	...
	<div class="content" style="float:left; width:700px;">
		...
		<c:if test="${not empty article.fileName}">
			<a href="<c:url value='/download/{boardId}/${article.fileName}'/>">
				<img src="<c:url value='/resources/img/data.png'/>" width="12" height="12"/> ${article.originFileName}
			</a>
		</c:if>
		...
		<p style="text-align:right;">
			...
			/ <a href="<c:url value='/board/recommend/${article.id}?token=${sessionScope._CSRF_TOKEN_}'/>">추천</a> 

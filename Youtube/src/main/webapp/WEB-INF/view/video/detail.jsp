...
<jsp:include page="/WEB-INF/view/common/layout/layout_header.jsp" />
 <script type="text/javascript">
	...
	<div>
		<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzuso2eBIcNkPQaz-hoLK2-G8GtXt49IQhRxBG1swpOAgHjUCrFw"
			id="icon" />${video.uploaderId}
		
	</div>
	<div>
		<a href="<c:url value='/video/delete/${video.videoId}'/>">삭제</a>
	</div>

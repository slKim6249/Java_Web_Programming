			...
			<c:forEach items="${groupVideo.videoList}" var="video">
				<a href="<c:url value='/video/detail/${video.videoId}' />">
					<article class="video">
						...
						<div>
							<article>
								<div class="uploader inline">${video.uploaderId}</div><br/>
								<div class="view-count inline">${video.viewCount} views ㆍ  </div>
								<div class="upload-date inline">${video.dateDiff}</div>
